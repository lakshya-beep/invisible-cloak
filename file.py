...
while (cap.isOpened()):
    ...
    #These values can also be changes as per the colour
    ...
    #open and expand the image where there is mask 1(colour)
    ...
    #Generating the final output by mergin resolution1 and resolution2
